const women = [
  ...
  "1875 | Anna Winlock",
  "One of the first members of the Harvard Computers. Winlock and her team contributed significantly to the Astromische Gesellschaft Katalog.",
  "ENIAC Programmers",
  "These were the six women who programmed the first all-electronic, programmable computer, the ENIAC. They were not recongized for their work until the mid-1980's.",
  "1952 | Grace Hopper",
  "Developed the first compiler/linker, the A-o system. This later led her to co-develop COBOL, one of the earliest high-level programming language.",
  ...
  "Programmed the first virus to infect RFID devices. This showed the devices' vulnerabilities, making such threats no longer theoretical.",
